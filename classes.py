...
def filepath(path):
    ...
    path_ = os.path.join(filepath, path) 
    return path_
...
class ChessPiece:
    def __init__(self, type_, pos, color, symbol, image):
        self.color = color
        self.pos = pos
        self.moves = None
        self.type = type_
...
class Rook(ChessPiece):
    def __init__(self, pos, color):
        if color == "White":
            image =  pygame.image.load(filepath('imagens/wR.png'))
        else:
            image =  pygame.image.load(filepath('imagens/bR.png'))
        super().__init__("Rook", pos, color, "R", image)
...
class Bishop(ChessPiece):
    def __init__(self, pos, color):
        if color == "White":
            image =  pygame.image.load(filepath('imagens/wB.png'))
        else:
            image =  pygame.image.load(filepath('imagens/bB.png'))
        super().__init__("Bishop", pos, color, "B", image)
...
class Knight(ChessPiece):
    def __init__(self, pos, color):
        if color == "White":
            image =  pygame.image.load(filepath('imagens/wN.png'))
        else:
            image =  pygame.image.load(filepath('imagens/bN.png'))
        super().__init__("Knight", pos, color, "N", image)
...
class Pawn(ChessPiece):
    def __init__(self, pos, color):
        if color == "White":
            image =  pygame.image.load(filepath('imagens/wp.png'))
        else:
            image =  pygame.image.load(filepath('imagens/bp.png'))
        super().__init__("Pawn", pos, color, "P", image)
...
class King(ChessPiece):
    def __init__(self, pos, color):
        if color == "White":
            image =  pygame.image.load(filepath('imagens/wK.png'))
        else:
            image =  pygame.image.load(filepath('imagens/bK.png'))
        super().__init__("King", pos, color, "K", image)
...
class Queen(ChessPiece):
    def __init__(self, pos, color):
        if color == "White":
            image =  pygame.image.load(filepath('imagens/wQ.png'))
        else:
            image =  pygame.image.load(filepath('imagens/bQ.png'))
        super().__init__("Queen", pos, color, "Q", image)
